package com.kevin.drift.Utils.CustomDialog;
...
public class KevinLoadingView extends DialogFragment{
    ...
    LoadingTextView mGraduallyTextView;
...
//            mGraduallyTextView = (LoadingTextView) view.findViewById(
